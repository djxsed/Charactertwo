...
NUMBER_PATTERN = r"\b(체력|지능|이동속도|힘)\s*:\s*([1-6])\b|\b냉철\s*:\s*([1-4])\b"
...
questions = [
    {
        "field": "포스트 이름",
        "prompt": "포스트 이름을 입력해주세요. (향후 수정 명령어 시 이 이름을 작성해야 합니다!)",
        "validator": lambda x: len(x) > 0,
        "error_message": "포스트 이름을 입력해주세요."
    },
    {
        "field": "종족",
        "prompt": "종족을 선택해주세요.",
    ...
    },
    {
        ...
        "prompt": "성별을 선택해주세요.",
        "options": ["남", "여", "불명"],
        "error_message": "허용되지 않은 성별입니다. 남, 여, 불명 중에서 선택해주세요."
    },
    {
        "field": "나이",
    ...
    {
        "field": "외모",
        "prompt": "외모를 설명(최소 20자)하거나 이미지를 업로드해주세요.",
        "validator": lambda x: (len(x) >= 20 if isinstance(x, str) and not x.startswith("이미지_") else True),
        "error_message": "외모 설명이 너무 짧습니다. 최소 20자 이상 입력하거나 이미지를 업로드해주세요."
    },
    {
        "field": "소속",
        "prompt": "소속을 선택해주세요.",
        "options": ["학생", "선생님", "A.M.L"],
    ...
    {
        "field": "냉철",
        "prompt": "냉철 수치를 선택해주세요.",
        "options": ["1", "2", "3", "4"],
        "error_message": "냉철은 1에서 4 사이의 숫자여야 합니다."
    },
    {
        "field": "사용 기술/마법/요력",
        "prompt": "사용 기술/마법/요력의 이름을 입력해주세요.",
        "validator": lambda x: len(x) > 0,
    ...
    },
    {
        ...
        "prompt": "사용 기술/마법/요력의 위력을 선택해주세요.",
        "options": ["1", "2", "3", "4", "5", "6"],
        "error_message": "위력은 1에서 6 사이의 숫자여야 합니다.",
        "is_tech": True
    },
    {
        "field": "사용 기술/마법/요력 쿨타임",
        "prompt": "사용 기술/마법/요력의 쿨타임을 입력해주세요. (예: 30초, 최소 위력 4는 15초, 위력 5는 20초, 위력 6은 40초로 해주세요.)",
        "validator": lambda x: len(x) > 0,
        "error_message": "쿨타임을 입력해주세요.",
        "is_tech": True
    },
    {
        "field": "사용 기술/마법/요력 지속시간",
        "prompt": "사용 기술/마법/요력의 지속시간을 입력해주세요. (예: 10초, 할퀴기나 주먹같은 단발 공격은 1초로 해주세요)",
        "validator": lambda x: len(x) > 0,
        "error_message": "지속시간을 입력해주세요.",
        "is_tech": True
    },
    {
    ...
    },
    {
        ...
        "prompt": "기술/마법/요력을 추가하시겠습니까?",
        "options": ["예", "아니요"],
        "error_message": "예 또는 아니요로 선택해주세요."
    },
    {
        "field": "과거사",
    ...
    while True:
        ...
        try:
            ...
            if pass_status:
                ...
                failed_fields = [field for field in answers if field in reason]
...
async def character_apply(interaction: discord.Interaction):
            ...
            while True:
                if question.get("options"):
                    ...
                    try:
                        ...
                        if question.get("validator") and not question["validator"](answer):
                ...
                while True:
                    if tech_question.get("options"):
                        ...
                        try:
                            ...
                            if tech_question.get("validator") and not tech_question["validator"](tech_answer):
    ...
    while True:
        ...
        for field in fields_to_correct:
            question = next(q for q in questions if q["field"] == field.split('_')[0])
            while True:
                if question.get("options"):
